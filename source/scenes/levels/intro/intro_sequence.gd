...
var intro_scenes: Array[Scene] = [
	Scene.new(
		...
		preload("res://resources/dialog/intro/intro1.dialogue")
	),
	Scene.new(
		preload("res://assets/textures/intro/intro2.png"),
		preload("res://resources/dialog/intro/intro2.dialogue")
	),
	Scene.new(
		preload("res://assets/textures/intro/intro3.png"),
		preload("res://resources/dialog/intro/intro3.dialogue")
	),
]
